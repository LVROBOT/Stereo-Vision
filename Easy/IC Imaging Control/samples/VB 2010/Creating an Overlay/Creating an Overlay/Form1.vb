...
Public Class Form1
	...
	Dim Sink As TIS.Imaging.FrameHandlerSink
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		Sink = New TIS.Imaging.FrameHandlerSink(False, New TIS.Imaging.FrameType("RGB32"))
    ...
    ''' <remarks></remarks>
        ...
        Dim Col As Integer = IcImagingControl1.ImageWidth / 2
        Dim Row As Integer = IcImagingControl1.ImageHeight / 2
    ...
    ''' <remarks></remarks>
        ...
        Try
            ...
            Dim Col As Integer = IcImagingControl1.ImageWidth - 5 - TheBitmap.Width
    ...
    ''' <remarks></remarks>
        ...
        Dim ob = IcImagingControl1.OverlayBitmap
        ...
        If IcImagingControl1.LiveVideoRunning Then
            ...
            Dim Col As Integer = IcImagingControl1.ImageWidth - 81
            Dim Row As Integer = IcImagingControl1.ImageHeight - 20
    ...
    ''' <remarks></remarks>
		...
		Dim lineIndex As Integer = Sink.FrameCount Mod 25

		If lineIndex = 0 Then
			' Delete the triangle.
			ob.DrawSolidRect(ob.DropOutColor, 10, _
										  IcImagingControl1.ImageHeight - 70, _
										  62, _
		...
		ob.DrawLine(Color.Yellow, lineIndex * 2 + 10, _
			IcImagingControl1.ImageHeight - 10, _
			lineIndex * 2 + 10, _
        ...
        ' Draw the text.
        ob.DrawText(Color.Yellow, 70, IcImagingControl1.ImageHeight - 19, Str(Sink.FrameCount) + "  ")
    ...
    Private Sub chkPPSink_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPPSink.CheckedChanged
        ...
        If chkPPSink.Checked Then
            ...
            If IcImagingControl1.DeviceValid Then
                ...
                SinkDisplay.Width = IcImagingControl1.ImageWidth + dx
                SinkDisplay.Height = IcImagingControl1.ImageHeight + dy
            End If
    ...
    Private Sub IcImagingControl1_ImageAvailable(ByVal sender As System.Object, ByVal e As TIS.Imaging.ICImagingControl.ImageAvailableEventArgs) Handles IcImagingControl1.ImageAvailable
        If Not SinkDisplay Is Nothing Then
            If Not SinkDisplay.IsDisposed Then
                SinkDisplay.BackgroundImage = e.ImageBuffer.Bitmap
            End If
        End If
    End Sub
