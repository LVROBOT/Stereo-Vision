    ...
    ''' <remarks></remarks>
        ...
        With IcImagingControl1
            If .DeviceValid Then
                ...
                .OverlayBitmap.DrawLine(Color.FromArgb(255, 0, 0), .ImageWidth - 1, 0, .ImageWidth - 1, .ImageHeight - 1)
                .OverlayBitmap.DrawLine(Color.FromArgb(255, 0, 0), .ImageWidth - 1, .ImageHeight - 1, 0, .ImageHeight - 1)
